...
namespace yche {
    ...
    Daemon::CommunityVecPtr Daemon::GetCommunitiesBasedOnLabelPropagationResult(
    ...
    void Daemon::DoLabelPropagationOnSingleVertex(unique_ptr<SubGraph> &sub_graph_ptr, SubGraphVertex &sub_graph_Vertex,
